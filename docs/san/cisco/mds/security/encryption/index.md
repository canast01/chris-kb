...
**SSH hardening — restrict algorithms:**

```bash
# NX-OS supports configuration of allowed ciphers and MACs
# Apply if the security baseline requires specific algorithm restrictions
ip ssh cipher-mode aes256
```
