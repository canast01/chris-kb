...
add_a_fabric_to_sannav_management -> discover_switches_in_a_fabric
discover_switches_in_a_fabric -> add_a_fabric_to_sannav
add_a_fabric_to_sannav -> discover_or_rediscover_switches_in_a
discover_or_rediscover_switches_in_a -> generate_a_fabric_health_report
generate_a_fabric_health_report -> configure_maps_alert_thresholds_and_
```
