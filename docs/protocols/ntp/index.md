...
<a class="kb-card" href="stratum/">
  <strong>Stratum</strong>
  <span>Stratum hierarchy (0–15), reference clocks, stratum selection strategy, and loop prevention.</span>
</a>

<a class="kb-card" href="sync/">
  <strong>Sync</strong>
  <span>Offset, drift, and jitter metrics — how to read chronyc tracking and w32tm /query output.</span>
</a>

<a class="kb-card" href="pools/">
  <strong>Pools</strong>
  <span>pool.ntp.org configuration, regional pool selection, and running an internal NTP pool for the organisation.</span>
</a>

<a class="kb-card" href="config/">
  <strong>Config</strong>
  <span>chrony vs ntpd vs Windows Time Service — configuration files, service management, and hardening.</span>
</a>
