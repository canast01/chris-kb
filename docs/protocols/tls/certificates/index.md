...
A TLS certificate is a signed X.509 document that binds a public key to an identity (hostname, IP, or service). The certificate allows clients to verify they are talking to the correct server and to establish encrypted sessions.
