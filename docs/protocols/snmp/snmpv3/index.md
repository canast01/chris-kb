...
SNMPv3 adds authentication and encryption to SNMP, replacing the plaintext community strings of v1/v2c. It is the required version for any environment with compliance requirements.
