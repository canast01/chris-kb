...
```text
┌─────────────────────────────── Virtualization Nutanix Learning Path.Md ───────────────────────────────┐
│                                                                                                       │
│   ┌───────────────────────────────────────────────────────────────────────────────────────────────┐   │
│   │                   Nutanix: Virtualization Nutanix Learning Path.Md platform                   │   │
│   │                                  Protocols: Various protocols                                 │   │
│   │             Management: Virtualization Nutanix Learning Path.Md management console            │   │
...
│   └───────────────────────────────────────────────────────────────────────────────────────────────┘   │
│                                                                                                       │
│    Physical: Virtualization Nutanix Learning Path.Md infrastructure · management network · monitorin  │
│                                                                                                       │
│    Key terms:                                                                                         │
│                                                                                                       │
│    Nutanix            = Virtualization Nutanix Learning Path.Md platform overview and core concepts   │
