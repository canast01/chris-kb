...
```text
┌────────────────────────────────── Virtualization Nutanix Operations ──────────────────────────────────┐
│                                                                                                       │
│   ┌───────────────────────────────────────────────────────────────────────────────────────────────┐   │
│   │                      Nutanix: Virtualization Nutanix Operations platform                      │   │
│   │                                  Protocols: Various protocols                                 │   │
│   │                Management: Virtualization Nutanix Operations management console               │   │
...
│   └───────────────────────────────────────────────────────────────────────────────────────────────┘   │
│                                                                                                       │
│    Physical: Virtualization Nutanix Operations infrastructure · management network · monitoring       │
│                                                                                                       │
│    Key terms:                                                                                         │
│                                                                                                       │
│    Nutanix            = Virtualization Nutanix Operations platform overview and core concepts         │
