...
<a class="kb-card" href="field-reference/">
  ...
  <span>Field Reference notes, checks, commands, and references.</span>
</a>
...
<a class="kb-card" href="overview/">
  ...
  <span>Overview notes, checks, commands, and references.</span>
</a>

<a class="kb-card" href="support-notes/">
  <strong>Support Notes</strong>
  <span>Support Notes notes, checks, commands, and references.</span>
</a>

<a class="kb-card" href="technical-deep-dive/">
  <strong>Technical Deep Dive</strong>
  <span>Technical Deep Dive notes, checks, commands, and references.</span>
</a>

<a class="kb-card" href="vxrail-manager/">
  <strong>VxRail Manager</strong>
  <span>VxRail Manager notes, checks, commands, and references.</span>
</a>
</div>
