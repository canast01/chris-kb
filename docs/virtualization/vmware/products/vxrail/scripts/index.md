...
lcm_upgrade_readiness_check_bash -> node_hardware_status_bash: uses
node_hardware_status_bash -> ansible_vxrail_health_playbook: uses
ansible_vxrail_health_playbook -> windows_vxrail_cluster_health_via_re: uses
windows_vxrail_cluster_health_via_re -> windows_vxrail_node_status_via_plink: uses
```
