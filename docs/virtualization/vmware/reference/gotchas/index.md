...
vsan_stretched_cluster_witness_must_ -> nsx_dfw_policy_must_be_published_to_: uses
nsx_dfw_policy_must_be_published_to_ -> nsx_transport_node_reboot_required_a: uses
nsx_transport_node_reboot_required_a -> nsx_edge_vm_cpu_must_be_pinned_to_a_: uses
```
