...
center -> 1_identify_which_host_failed_and_how
center -> 2_check_ha_restart_status
center -> 3_determine_storage_path_state_apd_v
center -> 4_check_vsan_resyncing_objects
center -> 5_powercli_validate_postfailover_sta
```
