...
<a class="kb-card" href="vcenter-ha-failover/">
  <strong>vCenter HA — Passive Node Failover</strong>
  <span>Confirm clean VCHA promotion, re-add old active as new passive, handle Isolated state.</span>
</a>

<a class="kb-card" href="vsan-witness-unreachable/">
  <strong>vSAN 2-Node — Witness Unreachable</strong>
  <span>Detect witness loss, restore connectivity or host, prevent unnecessary data rebuilds.</span>
</a>

<a class="kb-card" href="nsx-transport-node-prep-failed/">
  <strong>NSX Transport Node Prep Failed</strong>
  <span>Read exact error, remove conflicting VIBs, validate port reachability, retry cleanly.</span>
</a>

<a class="kb-card" href="vm-cpu-memory-contention/">
  <strong>VM CPU / Memory Contention — Balloon and Swap</strong>
  <span>Identify balloon vs swap pressure, resolve via DRS or vMotion, right-size allocations.</span>
</a>
