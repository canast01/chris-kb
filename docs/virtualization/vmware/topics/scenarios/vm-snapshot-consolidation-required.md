...
center -> 1_identify_all_affected_vms
center -> 2_check_snapshot_manager_and_datasto
center -> 3_attempt_vcenter_consolidation
center -> 4_diagnose_consolidation_failures
center -> 5_manual_vmkfstools_consolidation_ad
```
