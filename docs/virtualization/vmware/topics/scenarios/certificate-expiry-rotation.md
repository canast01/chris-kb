...
| NSX | VMware's software-defined networking platform — its manager and edge nodes hold their own certificates that must be rotated on the same schedule as vCenter/ESXi certificates |
