...
Technical and operational KBs for ESXi.
...
<a class="kb-card" href="networking/">
  ...
  <span>vSwitch, distributed switch, VMkernel adapters, uplinks, VLANs, and connectivity checks.</span>
</a>

<a class="kb-card" href="storage-paths/">
  <strong>Storage Paths</strong>
  <span>Datastore visibility, multipathing, HBA paths, latency, and path failover checks.</span>
</a>

<a class="kb-card" href="logs/">
  <strong>Logs</strong>
  <span>Common ESXi log locations, review patterns, and evidence collection.</span>
</a>

<a class="kb-card" href="maintenance-mode/">
  <strong>Maintenance Mode</strong>
  <span>Host evacuation, DRS behavior, validation, and return-to-service checks.</span>
</a>

<a class="kb-card" href="patching/">
  <strong>Patching</strong>
  <span>Patch readiness, lifecycle checks, remediation notes, and post-patch validation.</span>
</a>
