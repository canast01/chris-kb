...
- [vSphere Architecture Overview](../../../virtualization/vmware/products/vcenter/architecture/)
- [vSphere Health Check Runbook](../../../virtualization/vmware/products/vcenter/operations/health-checks/)
