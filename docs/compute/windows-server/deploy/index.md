...
Windows Server initial deployment: OS install, network configuration, NTP, Windows Update, domain join, firewall baseline, WinRM, and security baseline application.

*Applies to: Windows Server 2019 / 2022*
</div>

```text
┌──────────────────────────────────── Compute Windows Server Deploy ────────────────────────────────────┐
│                                                                                                       │
│   ┌───────────────────────────────────────────────────────────────────────────────────────────────┐   │
│   │                     Windows Server: Compute Windows Server Deploy platform                    │   │
│   │                                  Protocols: Various protocols                                 │   │
│   │                  Management: Compute Windows Server Deploy management console                 │   │
...
│   └───────────────────────────────────────────────────────────────────────────────────────────────┘   │
│                                                                                                       │
│    Physical: Compute Windows Server Deploy infrastructure · management network · monitoring           │
│                                                                                                       │
│    Key terms:                                                                                         │
│                                                                                                       │
│    Windows Server     = Compute Windows Server Deploy platform overview and core concepts             │
