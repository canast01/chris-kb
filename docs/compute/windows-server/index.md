...
<a class="kb-card" href="active-directory/"><strong>Active Directory</strong><span>Domain Services, DNS, FSMO roles, replication, trusts, and group policy.</span></a>
<a class="kb-card" href="sql-server/"><strong>SQL Server</strong><span>SQL Server installation, AG configuration, backup, monitoring, and performance.</span></a>
