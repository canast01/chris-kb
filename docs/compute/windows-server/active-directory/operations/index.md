...
│                                                                                                       │
│   ┌───────────────────────────────────────────────────────────────────────────────────────────────┐   │
│   │     Active Directory operations: day-2 procedures for administration and maintenance tasks    │   │
...
<a class="kb-card" href="cli-reference/">
  ...
  <span>Command reference for AD administration.</span>
</a>

<a class="kb-card" href="health-checks/">
  <strong>Health Checks</strong>
  <span>Daily checks, replication health, and DC status.</span>
</a>

<a class="kb-card" href="procedures/">
  <strong>Procedures</strong>
  <span>Change readiness, maintenance windows, and group/GPO procedures.</span>
</a>
...
<a class="kb-card" href="backup-restore/">
  ...
  <span>AD backup procedures and authoritative restore workflows.</span>
</a>
