<div class="hero">
  <div class="hero-body">
    ...
    <p>Deep technical documentation across the enterprise infrastructure stack — VMware virtualization, storage, SAN fabrics, cloud, disaster recovery, automation, and more. Structured for engineers who need accurate, production-ready references. Browse by topic above or start with the <a href="site-map/" style="color:#7dd3fc;">Site Map</a>.</p>
  </div>
  <div class="hero-name">
