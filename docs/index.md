<div class="hero">
  <div class="hero-body">
    ...
    <p>Production-grade notes, runbooks, and references across virtualization, storage, cloud, networking, and security — built from real environments, not documentation demos.</p>
  </div>
  <div class="hero-name">
    <strong>Chris Anastasiadis</strong>
...
<a class="kb-card" href="operations-playbooks/">
  <strong>Operations Playbooks</strong>
  <span>Daily checks, triage, maintenance windows, and post-change validation.</span>
</a>
