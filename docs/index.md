<div class="hero">
  <div class="hero-body">
    ...
    <p>Technical reference for enterprise infrastructure — virtualization, storage, SAN, cloud, compute, backup, disaster recovery, security, ITSM, protocols, and automation.</p>
  </div>
