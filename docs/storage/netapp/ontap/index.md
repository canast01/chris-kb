...
<a class="kb-card" href="architecture/"><strong>Architecture</strong><span>HA topology, WAFL engine, cluster networking, SVM design, and data protection built-ins.</span></a>
<a class="kb-card" href="operations/"><strong>Operations</strong><span>Health checks, procedures, CLI reference, scripts, and lifecycle.</span></a>
