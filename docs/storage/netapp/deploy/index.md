...
```text
┌──────────────────────────────────────── Storage Netapp Deploy ────────────────────────────────────────┐
│                                                                                                       │
│   ┌───────────────────────────────────────────────────────────────────────────────────────────────┐   │
│   │                             Netapp: Storage Netapp Deploy platform                            │   │
│   │                                  Protocols: Various protocols                                 │   │
│   │                      Management: Storage Netapp Deploy management console                     │   │
...
│   └───────────────────────────────────────────────────────────────────────────────────────────────┘   │
│                                                                                                       │
│    Physical: Storage Netapp Deploy infrastructure · management network · monitoring                   │
│                                                                                                       │
│    Key terms:                                                                                         │
│                                                                                                       │
│    Netapp             = Storage Netapp Deploy platform overview and core concepts                     │
