...
│                                                                                                       │
│   ┌───────────────────────────────────────────────────────────────────────────────────────────────┐   │
│   │          FlashArray: all-NVMe block and file array with inline dedup and compression          │   │
│   │                          Protocols: FC · iSCSI · NVMe-oF · NFS · SMB                          │   │
│   │                            Management: Purity GUI / purefa REST API                           │   │
...
│    SafeMode           = admin-locked immutable snapshots; cannot be deleted even by array administra  │
...
│    Evergreen          = Pure architecture; controllers upgrade non-disruptively, shelves remain in p  │
│                                                                                                       │
└───────────────────────────────────────────────────────────────────────────────────────────────────────┘
```
