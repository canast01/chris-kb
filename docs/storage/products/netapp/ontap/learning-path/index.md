...
tags:
  - learning-path
  - netapp
description: "Recommended reading order for NetApp ONTAP. Follow these stages in order to build a complete mental model before working with it in production."
---
