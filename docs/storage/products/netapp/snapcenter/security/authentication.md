...
- Use a dedicated ONTAP account (`svc-snapcenter`) with a custom least-privilege RBAC role — see the [Access Control](access-control.md) page for the recommended ONTAP role definition
