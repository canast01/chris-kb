...
![FOD — Procedures](../../../../assets/storage-dell-fod-operations-procedures.svg)
...
hub -> activate_a_features_on_demand_licenc
hub -> renew_an_expiring_fod_licence
hub -> list_all_active_fod_features
```
