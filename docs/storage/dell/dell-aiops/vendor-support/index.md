...
- Platform type and model (e.g., PowerStore 3000T)
- System serial number
- CloudIQ client ID
- Recommendation ID or anomaly ID (if applicable)
- SCG version and diagnostic bundle (for telemetry issues)
- Description of the issue with timestamps

| Resource | Details |
|---|---|
| Dell Support Portal | dell.com/support |
| CloudIQ Portal | cloudiq.dell.com |
