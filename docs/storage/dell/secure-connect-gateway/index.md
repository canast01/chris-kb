...
<a class="kb-card" href="scripts/">
  ...
  <span>Bash connectivity health check, Python device registration auditor, and Ansible SCG status playbook.</span>
</a>

<a class="kb-card" href="cli-reference/">
  <strong>CLI Reference</strong>
  <span>dsagw management commands, device registration, connectivity check, and log collection.</span>
</a>

<a class="kb-card" href="operations/">
  <strong>Operations</strong>
  <span>Daily connectivity checks, device health, incident triage, maintenance procedure, and post-change validation.</span>
</a>
