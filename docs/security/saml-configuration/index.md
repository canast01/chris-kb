...
│                                                                                                       │
│   ┌───────────────────────────────────────────────────────────────────────────────────────────────┐   │
│   │                    Saml Configuration: Security Saml Configuration platform                   │   │
│   │                                  Protocols: Various protocols                                 │   │
│   │                   Management: Security Saml Configuration management console                  │   │
...
│   └───────────────────────────────────────────────────────────────────────────────────────────────┘   │
│                                                                                                       │
│    Physical: Security Saml Configuration infrastructure · management network · monitoring             │
│                                                                                                       │
│    Key terms:                                                                                         │
│                                                                                                       │
│    Saml Configuration = Security Saml Configuration platform overview and core concepts               │
