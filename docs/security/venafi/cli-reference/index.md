...
flowchart LR
    Venafi["Venafi"]
    Venafi --> S0["vcert CLI — Authentication"]
    Venafi --> S1["Certificate Requests"]
    Venafi --> S2["Certificate Renewal"]
    Venafi --> S3["Certificate Retrieval"]
    Venafi --> S4["TPP REST API"]
    Venafi --> S5["Certificate Inspection (openssl)"]
```
