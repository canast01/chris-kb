...
│                                                                                                       │
│   ┌───────────────────────────────────────────────────────────────────────────────────────────────┐   │
│   │                            Gpu Workloads: Ai Gpu Workloads platform                           │   │
│   │                                  Protocols: Various protocols                                 │   │
│   │                        Management: Ai Gpu Workloads management console                        │   │
...
│   └───────────────────────────────────────────────────────────────────────────────────────────────┘   │
│                                                                                                       │
│    Physical: Ai Gpu Workloads infrastructure · management network · monitoring                        │
│                                                                                                       │
│    Key terms:                                                                                         │
│                                                                                                       │
│    Gpu Workloads      = Ai Gpu Workloads platform overview and core concepts                          │
