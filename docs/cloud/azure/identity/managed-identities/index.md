...
![Azure — Managed Identities](../../../../assets/cloud-azure-identity-managed-identities-index.svg)
...
center -> userassigned
center -> grant_access_via_rbac
center -> using_the_identity_in_code
center -> aks_workload_identity
