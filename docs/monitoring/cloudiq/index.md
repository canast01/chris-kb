...
<a class="kb-card" href="cli-reference/">
  ...
  <span>REST API authentication, endpoints, health queries, recommendations, and capacity reporting.</span>
</a>
...
<a class="kb-card" href="health/">
  <strong>Health</strong>
  <span>Health notes, checks, commands, troubleshooting, and validation.</span>
</a>

<a class="kb-card" href="recommendations/">
  <strong>Recommendations</strong>
  <span>Recommendations notes, checks, commands, troubleshooting, and validation.</span>
</a>

<a class="kb-card" href="capacity/">
  <strong>Capacity</strong>
  <span>Capacity notes, checks, commands, troubleshooting, and validation.</span>
</a>
...
<a class="kb-card" href="reporting/">
  ...
  <span>Reporting notes, checks, commands, troubleshooting, and validation.</span>
</a>
