...
```mermaid
graph LR
  VC["vCenter"] & NSX["NSX-T"] & ONTAP["NetApp ONTAP"] & FA["FlashArray"] --> RC["Remote Collector"]
  RC --> ANAL["Aria Operations\nAnalytics Cluster"]
  ANAL --> SN["ServiceNow\n(incidents)"]
  ANAL --> PD["PagerDuty\n(on-call)"]
  ANAL --> AUTO["Aria Automation\n(remediation)"]
  classDef ctrl fill:#2563eb,stroke:#1d4ed8,color:#fff
  classDef cloud fill:#0f766e,stroke:#0d5f58,color:#fff
  classDef host fill:#15803d,stroke:#166534,color:#fff
  class ANAL,RC ctrl
  class VC,NSX,ONTAP,FA host
  class SN,PD,AUTO cloud
```
