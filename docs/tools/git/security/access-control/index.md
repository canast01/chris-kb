...
Each layer can restrict or grant permissions. The most restrictive level wins.
...
| Role | Read | Write | Triage | Maintain | Admin |
|---|---|---|---|---|---|
| Read | Yes | No | No | No | No |
| Triage | Yes | No | Yes | No | No |
| Write | Yes | Yes | Yes | No | No |
| Maintain | Yes | Yes | Yes | Yes | No |
| Admin | Yes | Yes | Yes | Yes | Yes |

**Principle of least privilege:** Most developers should have Write. Only repository owners and maintainers need Admin.

### Team-Based Access

```bash
# Add a team to a repository via GitHub CLI
gh api --method PUT \
