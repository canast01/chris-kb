...
Examples:
- `Platform Engineering — Kubernetes Migration`
- `Security — Vulnerability Management`
- `Operations — Incident Management`

### Project Categories

Define a fixed set of project categories in `Admin → Project Categories`:

| Category | Usage |
|---|---|
| Engineering | Software development projects |
| Operations | ITSM, SRE, infrastructure projects |
| Business | Non-technical, business-unit projects |
| Archive | Completed/decommissioned projects |

---

## Issue Type Hierarchy

### Standard Issue Type Set
...
└── Story
    └── Task / Sub-task
Bug (standalone or child of Epic)
