...
```bash
# Verify the Confluence JVM process is running
pgrep -fl "confluence" || echo "ALERT: Confluence process not found"

# Verify the HTTP listener is active
ss -tlnp | grep 8090 || echo "ALERT: Port 8090 not listening"
```
