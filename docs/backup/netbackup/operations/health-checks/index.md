...
daily_check_flow: "Daily Check Flow" {shape: rectangle}
daily_checklist: "Daily Checklist" {shape: rectangle}
job_monitoring: "Job Monitoring" {shape: rectangle}
validation: "Validation" {shape: rectangle}
verify: "Verify" {shape: rectangle}
generate_report: "Generate Report" {shape: oval}

begin_checks -> run_this_routine
run_this_routine -> daily_check_flow
daily_check_flow -> daily_checklist
daily_checklist -> job_monitoring
job_monitoring -> validation
validation -> verify
