...
│                                                                                                       │
│   ┌───────────────────────────────────────────────────────────────────────────────────────────────┐   │
│   │                              Tls: Protocols Tls Ciphers platform                              │   │
│   │                                  Protocols: Various protocols                                 │   │
│   │                      Management: Protocols Tls Ciphers management console                     │   │
...
│   └───────────────────────────────────────────────────────────────────────────────────────────────┘   │
│                                                                                                       │
│    Physical: Protocols Tls Ciphers infrastructure · management network · monitoring                   │
│                                                                                                       │
│    Key terms:                                                                                         │
│                                                                                                       │
│    Tls                = Protocols Tls Ciphers platform overview and core concepts                     │
