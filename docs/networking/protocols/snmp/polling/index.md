...
center -> poll_operations
center -> common_cli_polling_commands
center -> common_oids_for_polling
center -> polling_intervals
center -> zabbix_snmp_polling_config
center -> prometheus_snmp_exporter
```
