...
### Ansible Process Isolation

```bash
# Run Ansible as dedicated non-root service account
useradd -r -s /bin/bash -m -d /home/ansible ansible

# Restrict project directory permissions
chown -R ansible: /opt/ansible-project
chmod 750 /opt/ansible-project
chmod 700 /home/ansible/.ssh

# Prevent other users reading vault password file
chmod 600 /home/ansible/.ansible_vault_pass
chown ansible: /home/ansible/.ansible_vault_pass
```
