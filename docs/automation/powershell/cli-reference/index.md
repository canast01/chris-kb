...
<a class="kb-card" href="core/">
  <strong>Core</strong>
  <span>Core notes, checks, commands, and references.</span>
</a>

<a class="kb-card" href="error-handling/">
  <strong>Error Handling</strong>
  <span>Error Handling notes, checks, commands, and references.</span>
</a>
...
<a class="kb-card" href="remoting/">
  <strong>Remoting</strong>
  <span>Remoting notes, checks, commands, and references.</span>
</a>
...
<a class="kb-card" href="services-processes/">
  <strong>Services & Processes</strong>
  <span>Services & Processes notes, checks, commands, and references.</span>
</a>

<a class="kb-card" href="variables-pipeline/">
  <strong>Variables & Pipeline</strong>
  <span>Variables & Pipeline notes, checks, commands, and references.</span>
</a>
