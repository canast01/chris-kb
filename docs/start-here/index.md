...
This KB is built for practical infrastructure work.

Use it when you need quick notes, runbooks, checks, standards, commands, or troubleshooting paths.
## Main workflow

1. Start with the major area.
2. Open the vendor, platform, or service.
3. Use the deeper cards for health checks, troubleshooting, commands, and validation.
4. Add real field notes as issues come up.
...
<a class="kb-card" href="../storage/">
  ...
  <span>Dell, Pure, NetApp, block, file, object, backup storage, and replication.</span>
</a>

<a class="kb-card" href="../cloud/">
  <strong>Cloud</strong>
  <span>AWS, Azure, identity, compute, networking, storage, monitoring, and cost.</span>
</a>

<a class="kb-card" href="../san/">
  <strong>SAN</strong>
  <span>Cisco, Brocade, zoning, fabrics, ports, ISLs, and host paths.</span>
</a>

<a class="kb-card" href="../ai/">
  <strong>AI</strong>
  <span>OpenAI, Azure OpenAI, AWS Bedrock, local AI, Ollama, and GPU workloads.</span>
</a>
...
<a class="kb-card" href="../usage-metrics.md">
  <strong>Usage Metrics</strong>
  <span>Page counts, section growth, and site health notes.</span>
</a>
