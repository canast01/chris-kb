...
> Part of the [SRM](../../index.md) > [Operations](../index.md) reference. VMware Live Site Recovery (formerly Site Recovery Manager) orchestrates disaster recovery workflows between two vCenter-managed sites.
</div>
