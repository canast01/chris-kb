...
<a class="kb-card" href="cycle-state/">
  <strong>Cycle State</strong>
  <span>Cycle State notes, checks, commands, and references.</span>
</a>
...
<a class="kb-card" href="lag/">
  <strong>Lag</strong>
  <span>Lag notes, checks, commands, and references.</span>
</a>
</div>
