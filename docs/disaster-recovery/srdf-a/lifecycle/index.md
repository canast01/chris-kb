...
| Platform | Status |
|---|---|
| VMAX3 (950F/850F) | End of Service Life — no new SRDF features; firmware-only support |
| PowerMax 2000 | Current — supported with latest HYPERMAX OS |
| PowerMax 8000 | Current — supported with latest HYPERMAX OS |
| PowerMax 9500 | Current — newest generation |
