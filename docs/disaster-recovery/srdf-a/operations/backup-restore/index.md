...
```bash
# Query status of all devices in an RDF device group
symrdf query -g <rdf_group_name>

# Example output fields:
# Device  Sym  RDF St  R1 St  R2 St  Mode    RPO
# 0100    DEV  RDF1    WD     WD     ASYNC   00:00:03
```
