...
### Image capture fails — share unreachable
...
# If this fails, check: password expiry, account lockout, firewall on port 445

# Check SMB signing compatibility
Get-SmbClientConfiguration | Select-Object RequireSecuritySignature
Get-SmbServerConfiguration | Select-Object RequireSecuritySignature
# Mismatch can cause connection failures — align both sides
```
