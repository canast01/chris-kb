...
tags:
  - confluence
  - learning-path
description: "Recommended reading order for Atlassian Confluence. Follow these stages in order to build a complete mental model before working with it in production."
---
