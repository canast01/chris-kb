...
<a class="kb-card" href="environment-readiness/"><strong>Environment Readiness</strong><span>Pre-deployment environment validation — infrastructure, dependencies, and configuration checks.</span></a>
</div>
