...
core_data_quality_dimensions -> ci_relationships: uses
ci_relationships -> import_sources_and_integration: uses
import_sources_and_integration -> servicenow_integration_notes: uses
servicenow_integration_notes -> governance_and_review_cadence: uses
```
