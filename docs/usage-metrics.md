...
| Metric | Count |
|---|---:|
| Total markdown pages | 2,628 |
| Sections | 11 |
| Pages with full-width ASCII diagrams | 2,617 |
| Pages with SVG diagrams | 118 |
| Pages with Mermaid diagrams | 680 |
| Pages with kb-summary | 2,348 |
| Pages with tags | 2,601 |
| Audit score | 36 / 37 |
