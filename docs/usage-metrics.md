...
| Metric | Count |
|---|---:|
| Total markdown pages | 2,629 |
| Sections | 11 |
| Pages with full-width ASCII diagrams | 2,618 |
| Pages with SVG diagrams | 118 |
| Pages with Mermaid diagrams | 680 |
| Pages with kb-summary | 2,349 |
| Pages with tags | 2,602 |
| Audit score | 36 / 37 |
