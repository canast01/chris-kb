...
def main():
    ...
    lines = [
        ...
        '## Summary',
        '',
        '| Metric | Last 7 days | Last 30 days | Definition |',
        '|---|---|---|---|',
        f'| **Page views** | {views7:,} | {views30:,} | Every time any page is loaded — one person visiting 5 pages counts as 5 |',
        f'| **Unique visits** | {visits7:,} | {visits30:,} | Individual sessions — one person visiting 5 pages still counts as 1 |',
        '',
        '## Top pages (30 days)',
        '',
        '| Views | Page |',
