...
VERSIONS = {
    ...
    'security/products/cyberark':             'CyberArk PAS 12.x',
    'security/products/venafi':               'Venafi Trust Protection Platform',
    'security':                      'All products (Security)',
    'storage/products/ceph':                  'Ceph 18.x (Reef)',
    'storage/products/dell/powermax':         'Dell PowerMax · VMAX',
    'storage/products/dell/powerflex':        'Dell PowerFlex 4.x',
    'storage/products/dell/powerpath':        'Dell PowerPath 7.x',
    'storage/products/dell/powerprotect':     'Dell PowerProtect Data Manager',
    'storage/products/dell/powerscale':       'Dell PowerScale (Isilon) 9.x',
    'storage/products/dell/powerstore':       'Dell PowerStore 3.x',
    'storage/products/dell/powervault':       'Dell PowerVault ME5',
    'storage/products/dell/cloudiq':          'Dell CloudIQ',
    'storage/products/dell/cod':              'Dell Cloud Object Detachment',
    'storage/products/dell':                  'Dell EMC Storage',
    'storage/products/netapp/snapmirror':     'NetApp ONTAP 9.x · SnapMirror',
    'storage/products/netapp/san':            'NetApp ONTAP 9.x · SAN',
    'storage/products/netapp/snapvault':      'NetApp ONTAP 9.x · SnapVault',
    'storage/products/netapp':                'NetApp ONTAP 9.x',
    'storage/products/pure/flasharray':       'Pure Storage FlashArray',
    'storage/products/pure/flashblade':       'Pure Storage FlashBlade',
    'storage/products/pure':                  'Pure Storage',
    'storage/runbooks':              'Storage (multi-vendor)',
    'virtualization/nutanix':        'Nutanix AOS 6.x · AHV',
    'virtualization/openshift':      'OpenShift 4.x',
    'virtualization/vmware/products/esxi':    'VMware ESXi 7.x / 8.x',
    'virtualization/vmware/products/vcenter': 'VMware vCenter 7.x / 8.x',
    'virtualization/vmware/vsphere': 'VMware vSphere 7.x / 8.x',
    'virtualization/vmware/products/vsan':    'VMware vSAN 7.x / 8.x',
    'virtualization/vmware/products/nsx':     'VMware NSX-T 3.x / 4.x',
    'virtualization/vmware/products/vxrail':  'Dell VxRail 7.x / 8.x',
    'virtualization/vmware/products/horizon': 'VMware Horizon 8.x',
    'virtualization/vmware/site-recovery': 'VMware SRM 9.x',
    'virtualization/vmware/aria':    'VMware Aria 8.x',
    'virtualization/vmware/products/tanzu':   'VMware Tanzu',
    'virtualization/vmware/hcx':     'VMware HCX 4.x',
    'virtualization/vmware/vcf':     'VMware Cloud Foundation 5.x',
    'virtualization/vmware/products/powercli': 'VMware PowerCLI 13.x',
    ...
    'virtualization/vmware/vcd':     'VMware Cloud Director 10.x',
    'virtualization/vmware/products/nsxalb':  'VMware NSX Advanced Load Balancer (Avi)',
