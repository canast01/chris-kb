...
def _():
    ...
    lines.append(txt_row('Thin provisioning = More logical capacity than physical; dedup + compression expand ratio'))
...
def _():
    ...
    lines.append(R(bMid(L, RR, 'Hosts applications: ND Insights (NDI), Fabric Controller (NDFC), Orchestrator (NDO)')))
